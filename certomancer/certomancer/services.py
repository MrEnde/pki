...
def choose_signed_digest(
    ...
    if signature_algo is None:
        ...
        if 'gost' in key_algo:
            bits = '256' if '256' in key_algo else '512'
            signature_algo = f'id-tc26-signwithdigest-gost3410-12-{bits}'
    ...
    if "gost" in signature_algo:
        signature_algo_obj['parameters'] = pub_key['algorithm']['parameters']
