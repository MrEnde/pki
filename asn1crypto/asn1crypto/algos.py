...
class SignedDigestAlgorithmId(ObjectIdentifier):
    ...
    _reverse_map = {
        ...
        'id-tc26-gost-3410-12-256-constants': '1.2.643.7.1.2.1.1',
        'id-tc26-gost-3410-12-256-paramSetA': '1.2.643.7.1.2.1.1.1',
        'id-tc26-gost-3410-12-256-paramSetB': '1.2.643.7.1.2.1.1.2',
    }


class Gost3410Parameters(Sequence):
    _fields = [
        ('public_key_param_set', SignedDigestAlgorithmId),
        ('digest_param_set', DigestAlgorithmId, {'optional': True})
    ]
...
class SignedDigestAlgorithm(_ForceNullParameters, Sequence):
    ...
    _oid_specs = {
        ...
        'id-tc26-signwithdigest-gost3410-12-512': Gost3410Parameters,
        'id-tc26-signwithdigest-gost3410-12-256': Gost3410Parameters
    }
    ...
    def signature_algo(self):
        ...
        algo_map = {
            ...
            'id-tc26-signwithdigest-gost3410-12-512': 'id-tc26-gost3410-12-512',
            'id-tc26-signwithdigest-gost3410-12-256': 'id-tc26-gost3410-12-256',
        }
    ...
    def hash_algo(self):
        ...
        if "gost" in algorithm:
            print(self['parameters'].native)
            print(algorithm)
            return self['parameters']['digest_param_set'].native
